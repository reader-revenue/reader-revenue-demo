...
function safeEnvVars() {
  const {GOOGLE_SITE_VERIFICATION, OAUTH_CLIENT_ID, PUBLICATION_ID, ENV_NAME, PROXY_URL, GTAG_PROPERTY_ID, GTAG_DEBUG_MODE} =
      process.env;
  return {GOOGLE_SITE_VERIFICATION, OAUTH_CLIENT_ID, PUBLICATION_ID, ENV_NAME, PROXY_URL, GTAG_PROPERTY_ID, GTAG_DEBUG_MODE};
}
